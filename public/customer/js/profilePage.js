...
function validInputsMousEnter(e) {
    ...
    e.target.style.borderColor = '#354024';
    e.target.style.transform = 'scale(1.025)';
    e.target.style.boxShadow = '0px 0px 10px #e5d7c4';
};
...
async function userInformation() {
    ...
    function recoveryEmailAddressChange() {
        if(recoveryEmailAddress.value != "") {
            ...
            recoveryEmailAddress.style.borderColor = 'white';
...
function passwordChange() {
    if(oldPassword.value != "") { 
        ...
        oldPassword.style.borderColor = 'white';
