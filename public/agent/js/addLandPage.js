...
const landType = document.querySelector('#AddProperty select');
...
landType.addEventListener("mouseenter", validInputsMousEnter);
...
landType.addEventListener("mouseleave", validInputsMousEave);
...
function inputChange() {
    ...
    if(landType.style.border != "none" && landType.value != "Any") {
        landType.removeEventListener("mouseenter", invalidInputsMousEnter);
        landType.removeEventListener("mouseleave", invalidInputsMousEave);

        landType.style.backgroundColor = '#4e6e5d';
        landType.style.color = '#f5f8f6';
        landType.style.border = 'none';
        landType.style.boxShadow = 'none';  
...
landType.addEventListener("change", inputChange);
...
function discardFunction() {
    ...
    if(landType.style.border != "none") {
        landType.value = "Any";

        landType.removeEventListener("mouseenter", invalidInputsMousEnter);
        landType.removeEventListener("mouseleave", invalidInputsMousEave);

        landType.style.backgroundColor == "rgb(250, 235, 207)";
        landType.style.color = '#f5f8f6';
        landType.style.border = 'none';
        landType.style.boxShadow = 'none';  
    ...
    if(price.style.border != "none") {
        ...
        price.style.backgroundColor == "rgb(250, 235, 207)";
        price.style.color = '#f5f8f6';
        price.style.border = 'none';
        price.style.boxShadow = 'none';  
...
async function saveFunction() {
    ...
    if(landType.value != "Any") {
        ...
        landType.removeEventListener("mouseenter", validInputsMousEnter);
        landType.removeEventListener("mouseleave", validInputsMousEave);

        landType.style.backgroundColor = '#f5f8f6';
        landType.style.color = '#000000';
        landType.style.border = 'solid red';
        landType.style.boxShadow = '0px 0px 10px red';
            
        landType.addEventListener("mouseenter", invalidInputsMousEnter);
        landType.addEventListener("mouseleave", invalidInputsMousEave);
    ...
    if(
        ...
        price.value != ""
            ...
            */
        const response = await fetch('https://dt-comia-realty-and-marketing-production.up.railway.app/add-land', {
            method: 'POST',
            headers: {                    
